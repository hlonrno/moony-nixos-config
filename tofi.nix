{
  ...
  settings = {
    ...
    font = "/nix/store/hj992xdia8h4c5p3h5sww8y39gny8kwf-nerd-fonts-jetbrains-mono-3.4.0+2.304/share/fonts/truetype/NerdFonts/JetBrainsMono/JetBrainsMonoNerdFont-Regular.ttf";
	font-size = 24; # pt
